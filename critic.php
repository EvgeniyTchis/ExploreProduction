            ...
            <div id="search_div">
                <form method="GET"action="critic.php">
                    ...
                    <input type="hidden" id="SearchNameQueryRequest" name="SearchNameQueryRequest">
                        <input class="search_bar" type="text" id="name_search" name="name_search" value="Search for Critic name">
                </form>
                  ...
                  <?php
                    ...
                    function printResult($result) { //prints results from a select statement        
                        while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                            echo "<tr class='result_header'><td>" . $row["CID"] . "</td><td>" . $row["NAME"] . "</td><td>" . $row["AFFILIATION"] . "</td></tr>"; //or just use "echo $row[0]" 
                        }
                    }
                    ...
                    function handleNameSearchRequest() {
                        ...
                        $result = executePlainSQL("SELECT * FROM Critic WHERE LOWER(NAME) LIKE LOWER('%$name%')");
