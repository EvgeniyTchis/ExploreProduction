<html>
    ...
    <body>
            ...
            <div id="menue_div">
                <form method="POST" action="delete-distributor.php">
                    <input type="hidden" id="DeleteQueryRequest" name="DeleteQueryRequest">
                        <input class="search_bar" type="text" id='did' name="did" value="DID">
                    <input class="button button_b button_s" type="submit" value="Delete" name="DeleteDistributorSubmit">
                    </form>
            </div>
        </div>
        <?php
        ...
        function handleDeleteRequest() {
            ...
            executePlainSQL("DELETE FROM distributor WHERE DID=$did");
            OCICommit($db_conn);
        }
	...
	// A better coding practice is to have one method that reroutes your requests accordingly. It will make it easier to add/remove functionality
		if (isset($_POST['DeleteDistributorSubmit'])) {
            handlePOSTRequest();
        }
		?>
