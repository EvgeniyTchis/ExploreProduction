            ...
            <div id="search_div">
                <form method="GET" action="filmstudio.php">
                    ...
                    <input type="hidden" id="SearchNameQueryRequest" name="SearchNameQueryRequest">
                        <input class="search_bar" type="text" id ="name_search"name="name_search" value="Search for film studio name">
                </form>
            </div>
            <div id="result_div">
                <table id="result_table">
                    ...
                    function printResult($result) { //prints results from a select statement        
                        while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                            echo "<tr class='result_header'><td>" . $row["FID"] . "</td><td>" . $row["NAME"] . "</td><td>" . $row["LOCATION"] . "</td></tr>"; //or just use "echo $row[0]" 
                        }
                    }
                    ...
                    function handleNameSearchRequest() {
                        ...
                        $result = executePlainSQL("SELECT * FROM filmstudio WHERE LOWER(NAME) LIKE LOWER('%$name%')");
