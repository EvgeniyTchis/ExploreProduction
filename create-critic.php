<html>
    ...
    <body>
            ...
            <div id="menue_div">
                <form method="POST" action="create-critic.php">
                    <input type="hidden" id="insertQueryRequest" name="insertQueryRequest">
                        <input class="search_bar" type="text" id="cid" name="cid" value="CID">
                        <input class="search_bar" type="text" id="name" name="name" value="Name">
                        <input class="search_bar" type="text" id="affiliation" name="affiliation" value="Affiliation">
        ...
        function handleInsertRequest() {
            ...
            executePlainSQL("INSERT INTO critic (CID, NAME, AFFILIATION) VALUES ($cid,'$name','$affiliation')");
            OCICommit($db_conn);
        }
	...
	// A better coding practice is to have one method that reroutes your requests accordingly. It will make it easier to add/remove functionality
		if (isset($_POST['CreateCriticSubmit'])) {
            handlePOSTRequest();
        }
		?>
