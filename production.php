            ...
            <div id="search_div">
                <form method="GET" action="production.php">
                    ...
                    <input type="hidden" id="SearchNameQueryRequest" name="SearchNameQueryRequest">
                        <input class="search_bar" type="text" id="name_search" name="name_search" value="Search for title name">
                </form>
                <form method="GET" action="production.php">
                    ...
                    <input type="hidden" id="SearchGenreQueryRequest" name="SearchGenreQueryRequest">
                        <input class="search_bar" type="text" id="genre_search" name="genre_search" value="Search Productions by genre">
                </form>
            </div>
            <div id="result_div">
