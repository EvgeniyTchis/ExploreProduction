            ...
            <div id="search_div">
                <form method="GET" action="personnel.php">
                    ...
                    <input type="hidden" id="SearchNameQueryRequest" name="SearchNameQueryRequest">
                        <input class="search_bar" type="text" name="name_search" value="Search for personel name">
                </form>
                ...
                <table id="result_table">
                    ...
                    function printResult($result) { //prints results from a select statement        
                        while ($row = OCI_Fetch_Array($result, OCI_BOTH)) {
                            echo "<tr class='result_header'><td>" . $row["SINUMBER"] . "</td><td>" . $row["NAME"] . "</td><td>" . $row["DEBUTDATE"] . "</td></tr>"; //or just use "echo $row[0]" 
                        }
                    }
                    ...
                    function handleNameSearchRequest() {
                        ...
                        $result = executePlainSQL("SELECT * FROM personnel WHERE LOWER(NAME) LIKE LOWER('%$name%')");
